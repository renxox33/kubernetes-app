...
kubectl set image deploymemts/client-deploymemt server=stephengrider/multi-client:$SHA
kubectl set image deploymemts/worker-deploymemt server=renxox33/multi-worker:$SHA
